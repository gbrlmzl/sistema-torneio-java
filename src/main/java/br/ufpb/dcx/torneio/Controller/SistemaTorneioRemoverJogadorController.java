...
import br.ufpb.dcx.torneio.Exception.ObjetoNuloException;
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            ...
            if(confirmar == 0){
                ...
                JOptionPane.showMessageDialog(janelaPrincipal, "Jogador " + jogadorRemover.getNickName() + " " + jogadorRemover.getTag() + " foi removido!");
            } else{
