...
public class SistemaTorneioCadastrarJogadorController implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            ...
            if(nickNameJogador == null) throw new OperacaoCanceladaException("Operação cancelada");
            ...
            if(eloSelecionadoString == null){
                eloSelecionado = null;
            }
            else if(eloSelecionadoString.equals("Sem ranque")){
            ...
            if(eloSelecionado == null) throw new OperacaoCanceladaException("Operação cancelada");
